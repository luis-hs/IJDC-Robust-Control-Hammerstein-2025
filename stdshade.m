function [lineOut, fillOut] = stdshade(amatrix,alpha,acolor,F,acolor2,lw)
...
hold on;
lineOut = stairs(F,amean, acolor2,'linewidth',lw); %% change color or linewidth to adjust mean line
if check
    hold off;
end
end
